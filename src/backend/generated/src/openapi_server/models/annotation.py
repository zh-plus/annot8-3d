...
class Annotation(BaseModel):
    ...
    def to_json(self, *, exclude_unset: bool = True, exclude_none: bool = True) -> str:
        """
        Returns the JSON representation of the model using alias and custom serialization options.

        Args:
            exclude_unset (bool): If True, only include fields that are explicitly set.
        ...
        return self.model_dump_json(exclude_unset=exclude_unset, exclude_none=exclude_none)
